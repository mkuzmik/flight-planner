...
// ── fmtTime ───────────────────────────────────────────────────────────────────
describe('fmtTime', () => {
    it('0.5h → "30m"', () => expect(fmtTime(0.5)).toBe('30m'));
    it('1.0h → "1h 00m"', () => expect(fmtTime(1.0)).toBe('1h 00m'));
    it('1.5h → "1h 30m"', () => expect(fmtTime(1.5)).toBe('1h 30m'));
    it('2.0h → "2h 00m"', () => expect(fmtTime(2.0)).toBe('2h 00m'));
